...
> behind them is not: 50 units are written to full procedural depth and 40 are
...
columns are ordered by where the catalogue's own edges run, and the 25 that run
...
| Test Units | 393 |
| Written to full procedural depth | **50** |
| Sketched | 40 |
| Outline only | 303 |
